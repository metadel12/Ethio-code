...
import { FaLinkedin, FaTwitter, FaGithub, FaDiscord, FaTelegram, FaSun, FaMoon } from "react-icons/fa";
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={toggleTheme}
                className="w-10 h-10 rounded-lg bg-slate-200 dark:bg-slate-700 hover:bg-emerald-600 flex items-center justify-center transition-all"
